...
namespace Antix.NuGet.API.Packages.Formatters
{
    public static class PackageSyndication
    {
            ...
            IPackageMetadata package, string rootUrl)
        {
            ...
            properties.Add(GetString("IconUrl", package.IconUrl));

            properties.Add(GetString("PackageHash", package.Hash));
            properties.Add(GetString("PackageHashAlgorithm", package.HashAlgorithm));
